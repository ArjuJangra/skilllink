...
>
  <div class="bg-white p-6 rounded-2xl shadow-lg text-center w-full max-w-sm">
    ...
    <div class="flex justify-center space-x-4">
      ...
      <p class="text-gray-500">Welcome to your dashboard. Sections coming soon...</p>
    </div>
  </div>
...
watch(showEditProfileForm, (newVal) => {
  if (newVal && provider.value) {
...
const handleLogout = () => {
  auth.logoutUser(); // Assuming this clears localStorage and token
  router.push("/login");
};
