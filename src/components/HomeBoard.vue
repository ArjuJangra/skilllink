      ...
      <transition enter-active-class="transition-transform duration-300 ease-out" enter-from-class="translate-x-full"
        ...
        <div v-if="isOpen" class="fixed inset-0 z-50 flex">
          ...
          <div class="w-64 h-full bg-white shadow-lg flex flex-col px-6 py-6 space-y-6 relative">
            ...
            <!-- Nav Items -->
            <router-link to="/about" class="text-lg font-semibold text-gray-600 hover:text-[#0073b1] transition"
              @click="closeMenu">
              About Us
            </router-link>
            <router-link to="/contact" class="text-lg font-semibold text-gray-600 hover:text-[#0073b1] transition"
              @click="closeMenu">
              Contact
            </router-link>
            <router-link :to="{ path: '/help', query: { from: 'homelogged' } }"
              class="text-lg font-semibold text-gray-600 hover:text-[#0073b1] transition" @click="closeMenu">
              Help
            </router-link>
