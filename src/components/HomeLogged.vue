<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <header class="w-full bg-white shadow-md">
      <div class="max-w-[1300px] mx-auto flex justify-between items-center px-6 py-4">
        <!-- Logo -->
        ...
        <div class="flex items-center gap-6 flex-wrap">
          <nav class="hidden sm:flex gap-6 text-gray-700 font-medium items-center">
            <router-link to="/about" class="text-[#0073b1] hover:text-[#005f91] text-sm font-medium no-underline">About
              Us</router-link>
            <router-link to="/contact"
              class="text-[#0073b1] hover:text-[#005f91] text-sm font-medium no-underline">Contact</router-link>
            <router-link :to="{ path: '/help', query: { from: 'homelogged' } }"
              class="text-[#0073b1] hover:text-[#005f91] text-sm font-medium no-underline">
              Help
            </router-link>
    ...
    <!-- Hero Section -->
    <section class="text-center py-12 bg-gradient-to-br from-blue-100 to-white">
      <div class="max-w-[1300px] mx-auto">
        <h2 class="text-3xl font-bold text-gray-800 mb-4">Connecting You to Trusted Local Experts</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div v-for="caseItem in solvedCases" :key="caseItem.title"
            ...
            <div class="w-full h-[240px] bg-gray-100 flex items-center justify-center">
              <img :src="caseItem.image" :alt="caseItem.title" class="w-full h-full object-fit-top" />
            </div>
            <div class="p-4">
    ...
    <section class="bg-blue-50 py-12 text-center">
      <div class="max-w-[1300px] mx-auto px-6">
        ...
        <p class="text-gray-700 text-lg mb-2">📧 Email: <a href="mailto:support@skilllink.in"
